...
class TestFluxStateFilter(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        ...
        logging.basicConfig(
            ...
            handlers=[
                ...
                logging.FileHandler("test_flux_state_filter.log"),
            ],
        )

        logging.info("Setting up test environment for FluxState with filtering.")
